...
execute_process(
    ...
    RESULT_VARIABLE SCORING_MATRICES_OK 
)

if (NOT SCORING_MATRICES_OK EQUAL 0)
  message(WARNING "Failed to import the `scoring_matrices` Python module")
endif()

# --- Detect default buffer size -----------------------------------------------

execute_process(
    COMMAND ${Python_EXECUTABLE} -c "import io; print(io.DEFAULT_BUFFER_SIZE, end='')"
    OUTPUT_VARIABLE DEFAULT_BUFFER_SIZE
)

set(CYTHON_DIRECTIVES
    ${CYTHON_DIRECTIVES}
    -E DEFAULT_BUFFER_SIZE=${DEFAULT_BUFFER_SIZE}
)

# --- Declare Cython extension -------------------------------------------------

macro(cython_extension _name)
  set(multiValueArgs LINKS DIRECTIVES INCLUDES)
  ...
  target_include_directories(${_target} AFTER PUBLIC ${CYTHON_EXTENSION_INCLUDES})  
