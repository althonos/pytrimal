...
GenericSimilarity::GenericSimilarity(Alignment *parentAlignment)
    : Similarity(parentAlignment) {}
...
GenericCleaner::~GenericCleaner() { delete[] hits; }

bool GenericCleaner::calculateSpuriousVector(float overlap,
                                             float *spuriousVector) {
  // Create a timer that will report times upon its destruction
  //	which means the end of the current scope.
  StartTiming("bool GenericCleaner::calculateSpuriousVector(float overlap, "
              "float *spuriousVector) ");
